          ...
          <div className="user_about">
            <table>
              <tbody>
                ...
                <tr>
                  <button onClick={() => handleProfileClick(console.log("ok"))} className='Edit_btn'>taxrirlash</button>
                </tr>
              </tbody>
            </table>
            ...
            <div className="Profile_social-media">
              ...
              <Link to="tik tok"><FaTiktok /> Tiktok</Link>
              <Link to="youtobe"><FaYoutube /> Youtobe</Link>
            </div>
          </div>
        })}
      </div>
