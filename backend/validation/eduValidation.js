...
const { addListener } = require("../models/educationModel");
...
const eduValidation = (req, res, next) => {
    const schema = {
        ...
        properties: {
            ...
            login: { type: "string", minLength: 8, maxLength: 15, pattern: "^[a-zA-Z0-9]{6,15}$" },
            password: { type: "string", minLength: 8, maxLength: 20, pattern: "^[a-zA-Z0-9]{6,15}$" },
        ...
        errorMessage: {
            ...
            properties: {
                ...
                "phone": "Phone must be between 9 digits",
                "login": "Login must be between 6 and 15 characters",
                "pasword": "Password must be between 8 and 15 characters",
    ...
    const result = ajv.validate(req.body);
